...
<div class="fieldcontain ${hasErrors(bean: hospitalInstance, field: 'limiteConsultas', 'error')} required">
	<label for="limiteConsultas">
		<g:message code="hospital.limiteConsultas.label" default="Limite Consultas" />
		<span class="required-indicator">*</span>
	</label>
	<g:field name="limiteConsultas" type="number" value="${hospitalInstance.limiteConsultas}" required=""/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: hospitalInstance, field: 'especialidades_hospital', 'error')} ">
	<label for="especialidades_hospital">
		<g:message code="hospital.especialidades_hospital.label" default="Especialidades do hospital" />
		
	</label>
	<g:select name="especialidades_hospital" from="${br.com.modular.modelos.Especialidade.list()}" multiple="multiple" optionKey="id" optionValue="nome" size="5" value="${hospitalInstance?.especialidades_hospital*.id}" class="many-to-many"/>
</div>

<div class="fieldcontain ${hasErrors(bean: hospitalInstance, field: 'medicos_hospital', 'error')} ">
	<label for="medicos_hospital">
		<g:message code="hospital.medicos_hospital.label" default="Médicos do hospital" />
...
<li class="add">
<g:link controller="medico" action="cadastrar" params="['hospital.id': hospitalInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'medico.label', default: 'Médico')])}</g:link>
</li>
</ul>
