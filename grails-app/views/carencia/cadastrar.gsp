...
<html>
	<head>
		...
		<title>Cadastrar Carência</title>
	</head>
	<body>
		<a href="#create-carencia" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-carencia" class="content scaffold-create" role="main">
			<h1>Cadastrar Carência</h1>
