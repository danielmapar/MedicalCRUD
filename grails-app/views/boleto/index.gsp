...
<html>
	...
	<body>
		...
		<div id="page-body" role="main">
 			...
 			<g:if test="${boletoNaoExiste==false}"> 			
			<b>Boleto:</b> <br/><br/>
			
			Nome: ${clienteInstance.nome} <br/>
			Sobrenome: ${clienteInstance.sobrenome} <br/>
			Idade: ${clienteInstance.idade} anos<br/>
			E-mail: ${usuarioInstance.email} <br/>
			Plano de Saúde: ${planoDeSaudeContratadoInstance?.planoDeSaude?.nome } <br/>
			Valor a pagar: ${planoDeSaudeContratadoInstance?.planoDeSaude?.valorMensalidade } reais <br/>
			Data de vencimento do boleto: ${planoDeSaudeContratadoInstance?.dataVencimentoBoleto }
...
<g:else>
	<b>Contrate um Plano de Saúde para gerar um boleto.</b>
</g:else>
